...
contract = web3.eth.contract(address='0x70c5eC93236da762EecE329B796E334818639Dd7', abi=abi)
        ...
        if menu == "0":
            ...
            if r == "Please enter your value":
                ...
                if check == "y":
                    ...
                    store_contact = contract.functions.openBid(name, value, h_x,h_y,b).buildTransaction({"chainId": 1337,'value': web3.toWei(1, 'ether'), 'gas': 2000000, "gasPrice": web3.eth.gas_price, "from": address, "nonce": web3.eth.getTransactionCount(address)})
